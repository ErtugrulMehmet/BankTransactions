...
namespace BankTransactions.Controllers
{
    ...
    {
        private readonly TransactionDnContext _context;

        public TransactionsController(TransactionDnContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TransactionDnContext.Transactions'  is null.");
            }
            var transaction = await _context.Transactions.FindAsync(id);
            if (transaction != null)
            {
